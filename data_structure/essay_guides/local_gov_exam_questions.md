...
**📊 考卷分析範圍**
- 分析考卷：10 份地方特考 (104-113年) + 關務/升官等特考
- 原始總題數：63 題 (包含重複題目)
- 實際不重複題數：約 45 題
- 難度評估：⭐⭐⭐⭐⭐ (理論與實作並重)

**📚 涵蓋主題**
- 樹（二元樹、AVL、B-Tree、Heap）
- 圖（BFS/DFS、MST）
- 排序、搜尋、雜湊
- 時間複雜度分析
...
<details open>
<summary><strong>🌳 樹狀結構（35% | 22題 | 難度⭐⭐⭐⭐）</strong></summary>
...
<details>
<summary><strong>🗺️ 圖論演算法（20% | 13題 | 難度⭐⭐⭐⭐⭐）</strong></summary>
...
<details>
<summary><strong>📊 排序演算法（15% | 10題 | 難度⭐⭐⭐⭐）</strong></summary>
...
<details>
<summary><strong>⏱️ 時間複雜度分析（12% | 8題 | 難度⭐⭐⭐⭐⭐）</strong></summary>
...
<details>
<summary><strong>🔑 雜湊表（8% | 5題 | 難度⭐⭐⭐）</strong></summary>

- Hash Function
- 衝突處理 (Linear Probing, Double Hashing)
</details>

<details>
<summary><strong>🔗 鏈結串列與陣列（10% | 6題 | 難度⭐⭐⭐）</strong></summary>
