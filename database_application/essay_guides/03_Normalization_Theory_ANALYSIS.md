# 03 Normalization Theory 完整題目解析 - 申論題答題框架

這份文件針對**03 Normalization Theory**相關題目提供詳盡的申論題答題架構。
...
|---------|------|
| **分析考卷總數** | **74 份** |
| **03 Normalization Theory相關題目** | **47 題** |
| **114年題目** | 2 題 |
| **重要性排名** | **No. 3 (理論基礎)** |
...
| 題型 | 占比 | 代表題目 | 難度 |
|------|------|---------|------|
| **功能相依推導** | 35% | Closure計算、候選鍵 | ⭐⭐⭐⭐⭐ |
| **正規形式判斷** | 25% | 判斷1NF/2NF/3NF/BCNF | ⭐⭐⭐ |
| **正規化分解** | 25% | 分解演算法、Lossless Join | ⭐⭐⭐⭐ |
| **實務應用** | 15% | 反正規化、效能考量 | ⭐⭐⭐ |
...
請參閱同目錄下的 `03_Normalization_Theory.md` 檔案以查看完整歷屆考題。
