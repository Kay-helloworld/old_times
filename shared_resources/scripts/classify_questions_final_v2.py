...
# Updated based on user feedback and unclassified check
CATEGORIES = {
    ...
    "04_app_web_security": [
        ...
        "ACID", "Transaction", "交易",
        # Added to catch unclassified Q2 (107190_2804)
        "軟體資訊系統", "軟體開發"
    ],
    ...
    "06_management_law_forensics": [
        ...
        # Added to catch unclassified Q1 (105150_1411) and Q4 (111160_0909)
        "資訊政策", "開放知識", "政府資訊公開法"
    ],
    "07_emerging_tech_cloud": [
        ...
        # Added to catch unclassified Q3 (110090_1226)
        "微型服務"
    ],
