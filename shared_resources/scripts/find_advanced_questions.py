...
def main():
    ...
    for filename in txt_files:
        ...
        try:
            ...
            if contains_keywords(content, ADVANCED_KEYWORDS):
    ...
    print(f"\n總共找到 {len(all_questions)} 題進階主題相關題目")
    
    output_path = "database_application/exam_resources/topic_lists/advanced_questions_list.txt"
    with open(output_path, "w", encoding="utf-8") as f:
        f.write(f"# 進階主題相關題目列表\n")
